var rid='18f54b0ba2ex9db4f8d1-x-kh6bm2';
...
$(`<style>
.nosel.d-flex.room.r18f54b0ba2ex9db4f8d1-x-kh6bm2 .fitimg.u-pic.borderg {
  letter-spacing: 1px;
  background-size: 108% 108%;
  -webkit-text-fill-color: white;
  animation: grad 2s cubic-bezier(.445,.05,.55,.95) alternate infinite;
}
.nosel.d-flex.room.r18f54b0ba2ex9db4f8d1-x-kh6bm2 .corner.fa.fa-user.label.uc.fa-microphone.label-danger {
  letter-spacing: 1px;
...
.nosel.d-flex.room.r18f54b0ba2ex9db4f8d1-x-kh6bm2.bord {border-inline: 0px solid #4c121e !important;}
.nosel.d-flex.room.r18f54b0ba2ex9db4f8d1-x-kh6bm2 .dots.mini.u-msg {
    text-align: center;
...
.nosel.d-flex.room.r18f54b0ba2ex9db4f8d1-x-kh6bm2 {
...
.nosel.d-flex.room.r18f54b0ba2ex9db4f8d1-x-kh6bm2 .u-topic.dots {
...
setInterval(function () {
    if (myroom == '18f54b0ba2ex9db4f8d1-x-kh6bm2') {
        if (l7dah == false) {
            l7dah = true;
